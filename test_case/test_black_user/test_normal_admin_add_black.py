...
class TestNormalAdminAddBlackApi(BlackUserAction):
    ...
    def test_normal_admin_to_normal_admin_forbid_visit(self):
        """
        测试普通管理踢出普通管理
        :return:
        """
    ...
    def test_normal_admin_to_normal_admin_forbid_shout(self):
        """
        测试普通管理对普通管理禁止喊话
        :return:
        """
    ...
    def test_normal_admin_to_normal_admin_forbid_speak(self):
        """
        测试普通管理对普通管理禁言
        :return:
        """
    ...
    def tearDown(self,*args):
        super(TestNormalAdminAddBlackApi,self).tearDown()
        for x in [self.user_id,self.high_admin_user_id]:
            del_super_visor_api = DelSuperVisorApi(self.anchor_login_name)
            del_super_visor_api.get({'user_id': x, 'anchor_id': self.anchor_id})
        for x in [self.user_id,self.other_anchor_id]:
