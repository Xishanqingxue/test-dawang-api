...
class BaseCase(TestCase):
    ...
    # def init_user_and_room(self,user_mobile,anchor_id):
    #     """
    #     初始化用户信息或房间信息
    #     :param user_id:
    #     :param room_id:
    ...
    #         if isinstance(user_mobile, (str, int)):
    #             MysqlOperation().fix_user_account(user_mobile).fix_user_rank_and_experience(). \
    #                 clean_user_exp_log().clean_user_account_log().clean_user_intimacy_rank().clean_user_contribution()
    #             RedisHold().clean_redis_user_detail(user_mobile)
    #         elif isinstance(user_mobile, (list, tuple, set)):
    #             for i in user_mobile:
    #                 MysqlOperation().fix_user_account(i).fix_user_rank_and_experience(). \
    #                     clean_user_exp_log().clean_user_account_log().clean_user_intimacy_rank().clean_user_contribution()
    ...
    #             MysqlOperation(anchor_id=anchor_id,user_id=anchor_id).fix_anchor_rank_and_exp().clean_user_account_log()
    ...
    def setUp(self):
        ...
        # cls.init_user_and_room(user_id,anchor_id)
