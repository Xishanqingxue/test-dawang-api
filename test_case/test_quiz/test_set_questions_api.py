...
class TestSetQuestionsApi(BaseCase):
    ...
    def test_set_questions_success(self):
        ...
        response = set_questions_api.get({'room_id': self.game_room, 'question': self.questions,'option_a':self.option_a,'option_b':self.option_b})
    ...
    def tearDown(self,*args):
        super(TestSetQuestionsApi,self).tearDown()
        for x in [self.other_room,self.game_room]:
