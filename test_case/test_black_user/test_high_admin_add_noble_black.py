...
class TestHighAdminAddBlackApi(BlackUserAction):
    ...
    def test_high_admin_to_monarch_forbid_visit(self):
        """
        测试高管踢出帝王
        :return:
        """
    ...
    def test_high_admin_to_monarch_forbid_shout(self):
        """
        测试高管对帝王禁止喊话
        :return:
        """
    ...
    def test_high_admin_to_monarch_forbid_speak(self):
        """
        测试高管对帝王禁言
        :return:
        """
    ...
    def tearDown(self,*args):
        super(TestHighAdminAddBlackApi, self).tearDown(self.user_id)
        del_super_visor_api = DelSuperVisorApi(self.anchor_login_name)
        del_super_visor_api.get({'user_id': self.high_admin_user_id, 'anchor_id': self.anchor_id})
        MysqlOperation(user_id=self.user_id).clean_user_noble().clean_black_user()
        # RedisHold().clean_redis_user_detail(self.user_id)
